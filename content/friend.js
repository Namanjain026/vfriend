  ...
  class VirtualFriendOverlay {
    ...
    createShadowDOM() {
      ...
      styleTag.textContent = `
        ...
        #vf-wrapper.size-small #vf-speech-bubble { font-size: 13px !important; padding: 8px 12px !important; max-width: 190px !important; margin-bottom: 2px !important; }
        #vf-wrapper.size-medium #vf-speech-bubble { font-size: 15px !important; padding: 10px 16px !important; max-width: 240px !important; margin-bottom: 3px !important; }
        #vf-wrapper.size-large #vf-speech-bubble { font-size: 18px !important; padding: 12px 18px !important; max-width: 300px !important; margin-bottom: 3px !important; border-radius: 18px !important; }
        #vf-wrapper.size-xlarge #vf-speech-bubble { font-size: 21px !important; padding: 14px 22px !important; max-width: 360px !important; margin-bottom: 4px !important; border-radius: 20px !important; }
        #vf-wrapper.size-xxlarge #vf-speech-bubble { font-size: 24px !important; padding: 16px 26px !important; max-width: 420px !important; margin-bottom: 4px !important; border-radius: 22px !important; }
